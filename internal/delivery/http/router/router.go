...
func Setup(
	...
	registerLoyaltySettingRoutes(api, loyaltySettingController, permissionUsecase, jwtSecret, blacklistRepo)

	registerDashboardRoutes(api, dashboardController, permissionUsecase, jwtSecret, blacklistRepo)
}
